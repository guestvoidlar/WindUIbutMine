...
function Button.New(Title, Icon, Callback, Variant, Parent, Dialog, FullRounded, Radius, IconColor)
    ...
    if Icon and Icon ~= "" then
        IconButtonFrame = New("ImageLabel", {
            ...
            ImageColor3 = IconColor or (Variant == "White" and Color3.new(0,0,0) or nil),
            ImageTransparency = Variant == "White" and .4 or 0,
            ThemeTag = (not IconColor) and {
